...
Over the Greenland ice sheet, there exists an anticorrelation between the long-term monthly temperature means $T_{ann}$ and the long-term monthly standard deviations $\sigma$ (Figure~\ref{fig:grl}). We then derive a linear relation between $T_{ann}$ and $\sigma$,
