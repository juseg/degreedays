...
Using gridded climate products, temperature variability can be assessed quantitatively at the continental scale. When using standard deviation PDD formulations \citep{braithwaite-1984,reeh-1991,calov-greve-2005}, the standard deviation of daily mean surface air temperatures is highly variable both spatially and seasonally, and this variability significantly affects the accuracy of annual PDD and glacier SMB estimations. Numerical glacier models that use an annual PDD scheme should implement spatially and seasonally variable standard deviations of mean daily surface air temperature in order to more realistically capture patterns of surface melt.
