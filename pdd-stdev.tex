...
The normal distribution approach has been implemented and used in several glacier models. However, $\sigma$ is often assumed constant in time and space, despite being a major constraint on modelled surface melt and subsequent ice sheet geometries \citep{charbit-etal-2013}. Here I show that $\sigma$ is in fact highly variable spatially and seasonally, which has significant effects on the PDD computation.

%TODO: Add refs to ice sheet models
